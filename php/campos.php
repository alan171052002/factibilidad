...
function getCamposDefinicion(): array {
    return [
        ...
        [
            ...
            'icono'  => '🏷️',
            'campos' => [
                ['clave'=>'tipo',  'label'=>'Tipo', 'tipo'=>'radio', 'peso'=>0, 'requerido'=>false,
        ...
        [
            ...
            'icono'  => '⭐',
            'campos' => [
                ['clave'=>'grado', 'label'=>'Grado', 'tipo'=>'radio', 'peso'=>0.01, 'requerido'=>false,
        ...
        [
            ...
            'icono'  => '📐',
            'campos' => [
                ['clave'=>'diseno_dibujo_maestro', 'label'=>'Dibujo Maestro Cliente / Customer Master Drawing',
                 'tipo'=>'select', 'peso'=>0.10, 'requerido'=>true,
                 'opciones'=>['','Disponible','En proceso','No aplica']],
                ['clave'=>'diseno_nivel_ingenieria','label'=>'Nivel de Ingeniería',
                 'tipo'=>'select','peso'=>0.02,'requerido'=>true,
                 'opciones'=>['','A','B','C','D','E']],
                ['clave'=>'diseno_muestra',         'label'=>'Muestra y/o Contraparte / Samples',
                 'tipo'=>'select','peso'=>0.03,'requerido'=>true,
        ...
        [
            ...
            'icono'  => '📏',
            'campos' => [
                ['clave'=>'spec_dimensionales',         'label'=>'Dimensionales',                                   'tipo'=>'select','peso'=>0.10,'requerido'=>true,  'opciones'=>['','Completo','Parcial','No aplica']],
                ['clave'=>'spec_geometricas',           'label'=>'Geométricas',                                     'tipo'=>'select','peso'=>0,   'requerido'=>true,  'opciones'=>['','Completo','Parcial','No aplica']],
        ...
        [
            ...
            'icono'  => '🔩',
            'campos' => [
                ['clave'=>'mat_tipo',   'label'=>'Tipo de Material (Estándar)',
                 'tipo'=>'checkbox', 'peso'=>0, 'requerido'=>false,
                 'opciones'=>['Barra (Red, Hex, Cuad) / Bar','Tubo (Circ, Cuad, Rectangular) / Tube','Solera - Placa / Metal Plate']],
                ['clave'=>'mat_preformado','label'=>'Tipo de Preformado',
                 'tipo'=>'checkbox','peso'=>0,'requerido'=>false,
                 'opciones'=>['Fundición / Casting','Forja / Forging','Extrusión / Estrusion','Piezas con Sobre Material','Corte Láser / Laser Cut']],
                ['clave'=>'mat_origen',    'label'=>'Origen de MP / Raw Material Origin',
                 'tipo'=>'text','peso'=>0.02,'requerido'=>true],
            ],
        ],
        ...
        [
            ...
            'icono'  => '📦',
            'campos' => [
                ['clave'=>'pre_dibujos2d_pre',   'label'=>'Dibujos 2D (PDF) Pre-Mecanizados',       'tipo'=>'select','peso'=>0,   'requerido'=>false,'opciones'=>['','Disponible','En proceso','No aplica']],
                ['clave'=>'pre_modelo3d_pre',     'label'=>'Modelo 3D (IGS/STEP) Pre-Mecanizados',   'tipo'=>'select','peso'=>0,   'requerido'=>false,'opciones'=>['','Disponible','En proceso','No aplica']],
                ['clave'=>'pre_dibujos2d_mec',   'label'=>'Dibujos 2D (PDF) Mecanizados',            'tipo'=>'select','peso'=>0,   'requerido'=>false,'opciones'=>['','Disponible','En proceso','No aplica']],
                ['clave'=>'pre_modelo3d_mec',    'label'=>'Modelo 3D (IGS/STEP) Mecanizados',        'tipo'=>'select','peso'=>0.10,'requerido'=>true, 'opciones'=>['','Disponible','En proceso','No aplica']],
                ['clave'=>'pre_dibujos_pex',     'label'=>'Dibujos 2D (PDF) Ensamble y/o PEX',       'tipo'=>'select','peso'=>0,   'requerido'=>false,'opciones'=>['','Disponible','En proceso','No aplica']],
